...
public class TestResource {
    ...
    /**
     * PUTs ALL in DB. For test purposes only!
     * test/
     *
     * @param values
     * @return status
    ...
    @Path(value = "/")
    public String putAll(String values) {
        for (GenericValue value : JsonHelper.readList(values)) {
            clientSessionBean.insert(value);
        }
    ...
    public String getId(
        ...
        return JsonHelper.writeList(clientSessionBean.findByClassNameAndFieldMatch("org.unict.ing.iot.utils.model.Tank", "tankId", id));
    }
